...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.kryvyiRihNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutKryvyiRihNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Кривий Ріг'
  const logoLink = RegionDniproPaths.kryvyiRihHome
  const lineNewsLink = RegionDniproPaths.kryvyiRihNews
  const newsPaperLink = RegionDniproPaths.kryvyiRihNewsToday
...
export default LayoutKryvyiRihNewspaper