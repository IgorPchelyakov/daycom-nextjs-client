...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.kamianskeNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutKamianskeNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Кам\'янське'
  const logoLink = RegionDniproPaths.kamianskeHome
  const lineNewsLink = RegionDniproPaths.kamianskeNews
  const newsPaperLink = RegionDniproPaths.kamianskeNewsToday
...
export default LayoutKamianskeNewspaper