...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.bilacerkvaNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutBilaCerkvaNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Біла Церква'
  const logoLink = RegionKyivPaths.bilacerkvaHome
  const lineNewsLink = RegionKyivPaths.bilacerkvaNews
  const newsPaperLink = RegionKyivPaths.bilacerkvaNewsToday
...
export default LayoutBilaCerkvaNewspaper