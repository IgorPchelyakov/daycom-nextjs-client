...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.boyarkaNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutBoyarkaNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Боярка'
  const logoLink = RegionKyivPaths.boyarkaHome
  const lineNewsLink = RegionKyivPaths.boyarkaNews
  const newsPaperLink = RegionKyivPaths.boyarkaNewsToday
...
export default LayoutBoyarkaNewspaper