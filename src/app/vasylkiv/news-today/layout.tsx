...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.vasylkivNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutVasylkivNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Васильків'
  const logoLink = RegionKyivPaths.vasylkivHome
  const lineNewsLink = RegionKyivPaths.vasylkivNews
  const newsPaperLink = RegionKyivPaths.vasylkivNewsToday
...
export default LayoutVasylkivNewspaper