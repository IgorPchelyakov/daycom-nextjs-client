...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.ternivkaNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutTernivkaNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Тернівка'
  const logoLink = RegionDniproPaths.ternivkaHome
  const lineNewsLink = RegionDniproPaths.ternivkaNews
  const newsPaperLink = RegionDniproPaths.ternivkaNewsToday
...
export default LayoutTernivkaNewspaper