...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.pavlogradNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutPavlogradNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Павлоград'
  const logoLink = RegionDniproPaths.pavlogradHome
  const lineNewsLink = RegionDniproPaths.pavlogradNews
  const newsPaperLink = RegionDniproPaths.pavlogradNewsToday
...
export default LayoutPavlogradNewspaper