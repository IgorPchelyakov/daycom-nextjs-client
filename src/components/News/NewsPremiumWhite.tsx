...
interface NewsPremiumWhite {
    data: News
    author: Author
}

const NewsPremiumWhite: FC<NewsPremiumWhite> = ({
    data,
    author
}) => {
        ...
        <>
            <div>
                <div className="relative flex">
                    <div className="max-w-[1920px] xl:flex xl:h-[970px]">
                        <div className="flex items-center justify-center border-b xl:w-1/2">
                            <div className="max-w-[720px] p-6 text-center">
                        ...
                        <div className="border-b xl:w-1/2">
                            <Image
                                src={data.mainImage}
                                alt={data.mainImgDesc}
                                preview={false}
                                className="min-h-[400px] object-cover xl:max-h-[970px] xl:min-h-[970px] xl:max-w-[1920px]"
                            />
...
export default NewsPremiumWhite