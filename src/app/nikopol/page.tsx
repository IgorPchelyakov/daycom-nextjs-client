...
const server = 'https://sside.daycom.online/api/nikopol/with-national-news'
...
export default async function Home() {
  ...
  const link = RegionDniproPaths.nikopolNews
  const pathToNewsToday = RegionDniproPaths.nikopolNewsToday
