...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.kyivNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutKyivNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Київ'
  const logoLink = RegionKyivPaths.kyivHome
  const lineNewsLink = RegionKyivPaths.kyivNews
  const newsPaperLink = RegionKyivPaths.kyivNewsToday
...
export default LayoutKyivNewspaper