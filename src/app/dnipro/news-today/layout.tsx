...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.dniproNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutDniproNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Дніпро'
  const logoLink = RegionDniproPaths.dniproHome
  const lineNewsLink = RegionDniproPaths.dniproNews
  const newsPaperLink = RegionDniproPaths.dniproNewsToday
...
export default LayoutDniproNewspaper