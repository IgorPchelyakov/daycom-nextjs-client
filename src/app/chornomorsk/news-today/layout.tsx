...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionOdesaPaths.chornomorskNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutChornomorskNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Чорноморськ'
  const logoLink = RegionOdesaPaths.chornomorskHome
  const lineNewsLink = RegionOdesaPaths.chornomorskNews
  const newsPaperLink = RegionOdesaPaths.chornomorskNewsToday
...
export default LayoutChornomorskNewspaper