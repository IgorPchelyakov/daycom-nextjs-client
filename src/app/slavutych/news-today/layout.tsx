...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.slavutychNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutSlavutychNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Славутич'
  const logoLink = RegionKyivPaths.slavutychHome
  const lineNewsLink = RegionKyivPaths.slavutychNews
  const newsPaperLink = RegionKyivPaths.slavutychNewsToday
...
export default LayoutSlavutychNewspaper