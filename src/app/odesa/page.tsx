...
const server = 'https://sside.daycom.online/api/odesa/with-national-news'
...
export default async function Home() {
  ...
  const link = RegionOdesaPaths.odesaNews
  const pathToNewsToday = RegionOdesaPaths.odesaNewsToday
