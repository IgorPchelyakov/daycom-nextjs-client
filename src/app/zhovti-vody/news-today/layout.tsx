...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.zhovtiVodyNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutZhovtiVodyNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Жовті Води'
  const logoLink = RegionDniproPaths.zhovtiVodyHome
  const lineNewsLink = RegionDniproPaths.zhovtiVodyNews
  const newsPaperLink = RegionDniproPaths.zhovtiVodyNewsToday
...
export default LayoutZhovtiVodyNewspaper