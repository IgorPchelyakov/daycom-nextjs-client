...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.pereyaslavNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutPereyaslavNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Переяслав'
  const logoLink = RegionKyivPaths.pereyaslavHome
  const lineNewsLink = RegionKyivPaths.pereyaslavNews
  const newsPaperLink = RegionKyivPaths.pereyaslavNewsToday
...
export default LayoutPereyaslavNewspaper