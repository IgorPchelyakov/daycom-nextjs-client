...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.buchaNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutBuchaNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Буча'
  const logoLink = RegionKyivPaths.buchaHome
  const lineNewsLink = RegionKyivPaths.buchaNews
  const newsPaperLink = RegionKyivPaths.buchaNewsToday
...
export default LayoutBuchaNewspaper