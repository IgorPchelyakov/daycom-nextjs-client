...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.marganetsNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutMarganetsNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Марганець'
  const logoLink = RegionDniproPaths.marganetsHome
  const lineNewsLink = RegionDniproPaths.marganetsNews
  const newsPaperLink = RegionDniproPaths.marganetsNewsToday
...
export default LayoutMarganetsNewspaper