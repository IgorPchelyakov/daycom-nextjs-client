...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.boryspilNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutBoryspilNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Бориспіль'
  const logoLink = RegionKyivPaths.boryspilHome
  const lineNewsLink = RegionKyivPaths.boryspilNews
  const newsPaperLink = RegionKyivPaths.boryspilNewsToday
...
export default LayoutBoryspilNewspaper