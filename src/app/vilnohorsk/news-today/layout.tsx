...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionDniproPaths.vilnohorskNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutVilnohorskNewspaper = ({
  children,
}: {
  children: React.ReactNode
}) => {
  const location = 'Вільногірськ'
  const logoLink = RegionDniproPaths.vilnohorskHome
  const lineNewsLink = RegionDniproPaths.vilnohorskNews
  const newsPaperLink = RegionDniproPaths.vilnohorskNewsToday
...
export default LayoutVilnohorskNewspaper