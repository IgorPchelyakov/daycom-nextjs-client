...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Сьогоднішня газета',
        description: 'Щодня ми працюємо для наших читачів, шукаємо правду та допомагаємо отримувати головні новини в Україні та з багатьох країн світу.',
        url: RegionKyivPaths.vyshneveNewsToday,
        type: 'website',
        locale: 'ua',
...
const LayoutVyshneveNewspaper = ({
  ...
  const lineNewsLink = RegionKyivPaths.vyshneveNews
...
export default LayoutVyshneveNewspaper